...
- `api/` — Vercel edge proxies (`/api/run` scores & players, `/api/lb` cached leaderboard)
- `supabase/migrations/` — `scores`, `players` (referrals), guard trigger, RLS, `leaderboard` view, pg_cron refresh
